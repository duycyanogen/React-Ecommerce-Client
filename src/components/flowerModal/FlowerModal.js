...
export default class FlowerModal extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            name: props.productInfo ? props.productInfo?.name : 'Hoa mặt trời mặt xinh dáng ngon',
            quantityIn: props.productInfo ? props.productInfo?.quantityIn : 1,
            price: props.productInfo ? props.productInfo?.price : '999999',
            contents: props.productInfo ? props.productInfo?.contents : 'Điện nước đầy đủ, công năng ok, chuyên đá trứng cút, xúc bình xăng con...',
            discount: props.productInfo ? props.productInfo?.discount : '15',
            errorMessage: '',
            files: null,
